    ...
    <div style="max-width: 600px; margin: auto; background-color: #fff; border-radius: 8px; padding: 20px; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
       ...
       <img src="{{ url('/api/track-email-open/'.$data['form_id']) }}" width="1" height="1" style="display: none;" alt="." />
        ...
        <p style="margin-top: 30px;">
            <a href="{{ url('api/redirect-to-iso-form/'.$data['form_id'].'/'.$encodedUrl) }}" target="_blank" style="background-color: #1d72b8; color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Please Complete the Co-Card Pre-Application
</a>
        </p>
